...
\author{\sc Theodore EHRENBORG
  \fix{I should thank Professor Leep, Professor Sarnak,
    and LAA at HCHS for giving me time.}
%\thanks{
...
given in Theorem~\ref{thm:8_classes}.
\end{conjecture}
...
the proof of Theorem~\ref{thm:counting_4D}.
\end{remark}

\section{Conjecture for $p = m = 4$ and $ n \in \Nnn $}
The conjecture in this section was made in collaboration with
...
Conjecture~\ref{conj:Ehrenborg-Leep}.


\begin{conjecture}
\label{conj:Ehrenborg-Leep}
...
Conjecture~\ref{conj:Ehrenborg-Leep} would be true if 
every $ \alpha \in \Lll[x,y,z,w] $ had a nontrivial
factorization over $ \Lll[x,y,z,w] $ given that
the norm $ \N(\alpha) $ has a nontrivial
factorization over $ \Zzz[x,y,z,w] $

However, Beauregard~\cite{Beauregard} provides a counterexample:
The quaternion
\[
x^2 y^2 - 1 + (x^2 - y^2)i + 2xyj
\]
is an irreducible in $ \Lll[x, y, z, w],$
but its norm is not an irreducible in $ \Zzz[x, y, z, w].$
Thus Conjecture~\ref{conj:Ehrenborg-Leep}
remains unproven.

\section{Proof of Conjecture~\ref{conj:Ehrenborg-Leep} when $n=1$}
I have proved Conjecture~\ref{conj:Ehrenborg-Leep}
...
\section{Enumerative Consequences of Conjecture~\ref{conj:Ehrenborg-Leep}} 

\begin{theorem}
\label{thm:counting_4D}
Assuming Conjecture~\ref{conj:Ehrenborg-Leep} holds,
...
\end{theorem}
\begin{proof}
If Conjecture~\ref{conj:Ehrenborg-Leep} holds, any
solution
...
\end{proof}
\begin{remark}
Note that the proof of Theorem~\ref{thm:counting_4D}
...
assuming Conjecture~\ref{conj:Ehrenborg-Leep}
holds.
...
the proof of Theorem~\ref{thm:counting_4D} to
