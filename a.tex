...
\begin{remark}
The prevalence of each equivalence class in the
set of solutions to $a^2 + b^2 + c^2 + d^2 = x^2 + y^2 + z^2 + w^2$
...
giving a different list of prevalences:
4, 3, 8, 6, 12, 6, 8, 8.
For instance, this list represents the number of
...
coefficient.
We denote the degree of  $ \theta $ with repect to the variable $x$ 
