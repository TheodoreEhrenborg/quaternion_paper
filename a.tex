...
\begin{lemma}[G. Davidoff, P. Sarnak, and A. Valette, 2.6.10]
\label{thm:prime_iff_norm_prime}
A Hurwitz integer $\alpha$ is irreducible iff its norm $N(\alpha)$ is a prime in $\Nnn$.
\end{lemma}

\fix{Insert Hurwitz citation, p 321 of the book is where it's proved}
...
As a result of Lemma~\ref{thm:prime_iff_norm_prime},
a quaternion
...
\fix{What is the name of this type of argument? Diophantus chord method?}
\end{figure}
...
An algebraic proof of the general case of a sum of $n$ squares can be found in Mordell, ch 3, thm 1, \fix{Cite it}
\fix{And mention that Mordell uses Gaussian integers to get Pythagorean quintuples}
...
in this section, and I don't see how it is directly relevant. Compare with
second paper}
...
A. Hurwitz,  ̈Uber die Zahlentheorie der Quaternionen, Nachrichten von
der k. Gesellschaft der Wissenschaften zu G ̈ottingen, Mathematisch-
physikalische Klasse, 1896, S. 313-340
\end{comment}
