...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This should contain all the information from my 2018 state 
% science fair poster and more 
%
%how to cite -- https://faculty.math.illinois.edu/~hildebr/tex/bibliographies.html
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Hatcher's notes~\cite{Hatcher_book}
...
\bibitem{Polynomial_parametrization}
