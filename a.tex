...
See Figures~\ref{fig:Pythagorean} 
and~\ref{fig:Pythagorean_squared} for diagrams of this 
concept.
...
See Figure~\ref{fig:multiplication_table} 
...
(see Theorem~\ref{thm:unique_factorization}) suggested to
...
For sufficiently large prime $\epsilon$, 
\begin{align*}
